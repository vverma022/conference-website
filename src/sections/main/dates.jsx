...
const conferenceDates = [
  { date: "1 March 2025", day: "Call for Paper" },
  ...
  >
    <div className="container mx-auto px-4">
      ...
      <div className="relative h-32 overflow-hidden">
        <div className="absolute inset-0 animate-scroll-horizontal flex items-center space-x-10">
          {conferenceDates.concat(conferenceDates).map((item, index) => (
            <div
              key={index}
              className="flex-shrink-0 w-48 border rounded-lg p-4 text-center"
            >
