  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        >
          School of Computer and Communication Engineering, Manipal University Jaipur, India is organizing the International Conference on Smart and Distributed Computing (ICSDC-2025). The conference invites industry professionals, academics, and researchers to submit original, high-quality, and previously unpublished research papers. The event focuses on tackling research challenges within the fields of Smart and Distributed Computing.
